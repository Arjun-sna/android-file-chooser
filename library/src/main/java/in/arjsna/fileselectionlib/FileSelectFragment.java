...
public class FileSelectFragment extends Fragment
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        fileType = getArguments().getInt(FileLibUtils.FILE_TYPE_TO_CHOOSE, FileLibUtils.FILE_TYPE_IMAGES);
        setUpActionBar();
        initialiseViews();
        bindEvents();
        fetchFiles();
    ...
    private void bindEvents() {
        ...
        final GestureDetector
            gestureDetector = new GestureDetector(getActivity(), FileSelectFragment.this);
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                switch (event.getAction() & MotionEvent.ACTION_MASK){
                    case MotionEvent.ACTION_DOWN:
                        ...
                        mDownY = event.getY();
                        if(view != null) {
                            view.startAnimation(AnimationUtils.loadAnimation(getActivity(), R.anim.scale_down_anim));
                        }
                        isOnClick = true;
                        break;
                    ...
                    case MotionEvent.ACTION_CANCEL:
                        if(isOnClick){
                            if(view != null) {
                                view.startAnimation(AnimationUtils.loadAnimation(getActivity(), R.anim.scale_up_anim));
...
//                            View viewup = mFilesListView.findChildViewUnder(event.getX(), event.getY());
    ...
    private void fetchFiles() {
        ...
        titleView.setText(getResources().getString(R.string.selected_item_count, bucketName, 0, files.size()));
    ...
    public FilesListAdapter.SelectedItemChangeListener selectedItemChangeListener = new FilesListAdapter.SelectedItemChangeListener() {
        @Override
        public void onSelectedItemsCountChanged() {
            ...
            titleView.setText(getResources()
                    .getString(R.string.selected_item_count,
                            bucketName,
                            selectedItemCount,
                            bucketContentCount));
